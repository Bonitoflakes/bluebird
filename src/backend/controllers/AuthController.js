...
export const signupHandler = function (schema, request) {
  ...
  try {
    ...
    const encodedToken = sign({ _id, username }, import.meta.env.VITE_APP_JWT_SECRET);
...
export const loginHandler = function (schema, request) {
  ...
  try {
    ...
    if (foundUser) console.log("user is found");

    if (password === foundUser.password) {
      console.log("inside password check");
      console.log(import.meta.env.VITE_APP_JWT_SECRET);
      const encodedToken = sign({ _id: foundUser._id, username }, import.meta.env.VITE_APP_JWT_SECRET);
      console.log("encodedToken", encodedToken);
